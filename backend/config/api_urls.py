...
urlpatterns = [
    ...
    path(
        ...
        BoxDeactivateAPIView.as_view(),
        name="api_box_archive",
    ),
    path(
        "boxes/<int:box_id>/deactivate/",
        BoxDeactivateAPIView.as_view(),
        name="api_box_deactivate",
    ),
    path(
    ...
    path(
        "boxes/<int:box_id>/qualify/",
        BoxQualifyAPIView.as_view(),
        name="api_box_qualify",
    ),
    path(
