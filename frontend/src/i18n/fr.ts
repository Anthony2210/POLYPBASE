export const fr = {
  ...
  adminPage: 'Page',
  adminTabUsers: 'Comptes et accès',
  adminTabReferences: 'Référentiel biologique',
  adminTabLocations: 'Emplacements et sondes',
  adminTabOrganizations: 'Institutions partenaires',
  adminTabTransfers: 'Échanges entre institutions',
  adminTabHistory: 'Journal des actions',
