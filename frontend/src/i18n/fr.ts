export const fr = {
  ...
  profileActiveOrganization: 'Institution active',
  profileActiveOrganizationHelp: 'Ce choix sera repris automatiquement à la prochaine connexion.',
  profileDefaultOrganization: 'Par défaut',
