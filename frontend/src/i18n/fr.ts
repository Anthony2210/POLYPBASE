export const fr = {
  ...
  auditDescriptionMeasurementCreated: 'Relevé biologique enregistré pour le {date}',
  auditDescriptionMeasurementCreatedLegacy: 'Relevé biologique enregistré',
  auditDescriptionMeasurementCorrected: 'Relevé biologique corrigé pour le {date}',
  ...
  auditDetailTechnical: 'Détails techniques',
  auditCorrectMeasurement: 'Corriger ce relevé',
  auditCorrectMeasurementHelp: 'Ouvre la fiche de {code}, relevé du {date} pré-rempli.',
  ...
  profileActionsText: 'Vos actions enregistrées dans l’institution active.',
  profileActionsCount: 'actions',
