...
export const en: Record<TranslationKey, string> = {
  ...
  profileActiveOrganization: 'Active institution',
  profileActiveOrganizationHelp: 'This choice will be used automatically the next time you sign in.',
  profileDefaultOrganization: 'Default',
