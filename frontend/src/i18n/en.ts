...
export const en: Record<TranslationKey, string> = {
  ...
  auditDescriptionMeasurementCreated: 'Biological measurement recorded for {date}',
  auditDescriptionMeasurementCreatedLegacy: 'Biological measurement recorded',
  auditDescriptionMeasurementCorrected: 'Biological measurement corrected for {date}',
  ...
  auditDetailTechnical: 'Technical details',
  auditCorrectMeasurement: 'Correct this measurement',
  auditCorrectMeasurementHelp: 'Opens the {code} sheet with the {date} measurement pre-filled.',
  ...
  profileActionsText: 'Your recorded actions in the active institution.',
